...
const rentPropertiesData = [
  ...
  return (
    <main>
      <Hero />
      <Testimonials />
      <PropertiesSection variant='rent' properties={rentPropertiesData} description='Explore our handpicked properties for sale and find the perfect space to call your own. Quality homes. Great locations. Better living.' />
      <PropertiesSection variant='sale' properties={salePropertiesData}  description='Explore our handpicked properties for sale and find the perfect space to call your own. Quality homes. Great locations. Better living.'/>
    </main>
  )
}
